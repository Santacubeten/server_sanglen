...
class SurnameRoutes {
  ...
  Router get router {
    ...
    router.post('/', (Request request) async {
      ...
      await _connection.surnameRepository.createSurname(surname);
    ...
    router.get('/', (Request request) async {
      final surnames = await _connection.surnameRepository.getAllSurnames();
      return AppResponse.success(
    ...
    router.get('/clan/<clanId>', (Request request, String clanId) async {
      final surnames =
          await _connection.surnameRepository.getSurnamesByClanId(int.parse(clanId));
      if (surnames.isEmpty) {
    ...
    router.get('/<id>', (Request request, String id) async {
      final surname =
          await _connection.surnameRepository.getSurnameById(int.parse(id));
      if (surname != null) {
    ...
    router.put('/<id>', (Request request, String id) async {
      final body = await request.readAsString();
      final surname = SurnameModel.fromJson(jsonDecode(body));
      await _connection.surnameRepository.updateSurname(surname);
      return AppResponse.success(
    ...
    router.delete('/<id>', (Request request, String id) async {
      await _connection.surnameRepository.deleteSurname(int.parse(id));
